<?php
    class Sync {
        ...
        */
        ...
        private function backup_createTables(PDO $db) : bool
        {
            if(!$this->isOpen()) { return false; }
            /*
        ...
        public function backup_writeTo(string $str_to_db) : bool
        {
            if(!$this->isOpen()) { return false; }
            ...
            */
            ...
            $this->backup_setActive($to_db, false);
        ...
        private function backup_setActive(PDO $db, bool $value) : void
        {
        ...
        private function backup_isActive(PDO $db) : bool
        {
